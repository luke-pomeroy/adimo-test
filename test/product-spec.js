...
describe ('Product class', function () {
    let product1, product2, product3, products, average
    ...
    describe('Product constructor', () => {
        ...
        it('should have set the previousPrice property', () => {
            ...
            expect(product1.previousPrice).to.eql("£0.00")
        })
    ...
    describe('getDiscount instance method', () => {
        it('should set discountAmount to £0.00 if previousPrice == £0.00', () => {
            expect(product1.discountAmount).to.eql("£0.00")
        })

        it('should set discountAmount correctly if previousPrice != £0.00', () => {
            expect(product3.discountAmount).to.eql("£5.00")
        })
    })

    describe('averageCurrentPrice static method', () => {
        let average = Product.averageCurrentPrice(products)
